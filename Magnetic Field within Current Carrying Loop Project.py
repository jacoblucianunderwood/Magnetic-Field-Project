...
xComponent = 0.04#float(input('Enter the distance from the origin (center of the loop) along the x-value for your point, in meters: '))
yComponent = 0.02#float(input('Enter the distance from the origin (center of the loop) along the y-value for your point, in meters: '))
zComponent = 0.01#float(input('Enter the distance from the origin (center of the loop) along the z-value for your point, in meters: '))
point = [xComponent,yComponent,zComponent] #location of point in cartesian
...
for i in range(segments):
    ...
    xHat.append((point[0]-radX[i])/rMagnitude[i])
    yHat.append((point[1]-radY[i])/rMagnitude[i])
    zHat.append((point[2])/rMagnitude[i])
...
#print('xHat Vals:', xHat)
#print('Icross values: ',iCross)
#print("x Values of Mag Differential: ", dBx)
